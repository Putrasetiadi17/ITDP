...
export default function DashboardModalPopup(props: DashboardModalPopupProps) {
    ...
    return (
        <>
            ...
            {
                isCloseModal && (
                    <Modal onClose={onClose} className="w-[42vw] h-[50vh]">
                        <div className="flex flex-col items-center justify-center h-full gap-8 p-20">
                            <div className="flex flex-col items-center">
                                <IoWarningOutline size={65} className="text-red-600"/>
                                <h2>Yakin ingin membatalkan proses eksekusi</h2>
                            </div>
                            <div className="flex flex-col gap-4 w-[400px] items-center">
                                <button className="bg-blue-500 text-white px-4 py-2 rounded-md w-[95px] hover:bg-blue-600 w-[350px]" onClick={onCloseModalClose}>Tidak</button>
                                <button className="border border-red-600 text-red-600 px-4 py-2 rounded-md w-[95px] hover:bg-red-600 hover:text-white w-[350px]" onClick={onConfirmModalClose}>
                                    Ya</button>
                            </div>
                        </div>
                    </Modal>
