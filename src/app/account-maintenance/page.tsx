...
import TableAccountMaintenance from "@/contents/raport-account-officer/table-account-maintenance"

export default function AccountMaintenance(){    
    const index = 6
    const bcItems = [
        {label: SideBarMenuNav[index].name},
        {label: SideBarMenuNav[index].subMenu[2].name, path: SideBarMenuNav[index].subMenu[0].ref},
    ] as BreadcrumbItem[]
